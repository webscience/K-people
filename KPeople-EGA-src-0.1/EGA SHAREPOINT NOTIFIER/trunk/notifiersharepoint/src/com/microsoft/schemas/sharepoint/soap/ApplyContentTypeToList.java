 ...
 */
            ...
            /**
            *  ApplyContentTypeToList bean class
            */
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ApplyContentTypeToList.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ApplyContentTypeToList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ApplyContentTypeToList",
                                        ...
                                        xmlWriter.writeStartElement("webUrl");
                                          ...
                                          if (localWebUrl==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("webUrl cannot be null!!");
    ...
    public static class Factory{
        ...
        */
        public static ApplyContentTypeToList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ApplyContentTypeToList object =
                new ApplyContentTypeToList();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ApplyContentTypeToList".equals(type)){
                                ...
                                return (ApplyContentTypeToList)com.microsoft.schemas.sharepoint.soap.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
