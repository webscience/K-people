 ...
 */
            ...
            /**
            *  AddListFromFeatureResponse bean class
            */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.microsoft.schemas.sharepoint.soap.AddListFromFeatureResult_type0 localAddListFromFeatureResult ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.microsoft.schemas.sharepoint.soap.AddListFromFeatureResult_type0
                           */
                           public  com.microsoft.schemas.sharepoint.soap.AddListFromFeatureResult_type0 getAddListFromFeatureResult(){
                            ...
                            /**
                               ...
                               */
                               public void setAddListFromFeatureResult(com.microsoft.schemas.sharepoint.soap.AddListFromFeatureResult_type0 param){
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddListFromFeatureResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AddListFromFeatureResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AddListFromFeatureResponse",
                ...
                if (localAddListFromFeatureResultTracker){
                                            if (localAddListFromFeatureResult==null){
                                                 throw new org.apache.axis2.databinding.ADBException("AddListFromFeatureResult cannot be null!!");
                                            }
                                           localAddListFromFeatureResult.serialize(new javax.xml.namespace.QName("http://schemas.microsoft.com/sharepoint/soap/","AddListFromFeatureResult"),
                                               factory,xmlWriter);
                                        }
    ...
    public static class Factory{
        ...
        */
        public static AddListFromFeatureResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddListFromFeatureResponse object =
                new AddListFromFeatureResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddListFromFeatureResponse".equals(type)){
                                ...
                                return (AddListFromFeatureResponse)com.microsoft.schemas.sharepoint.soap.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.microsoft.com/sharepoint/soap/","AddListFromFeatureResult").equals(reader.getName())){
                                                ...
                                                object.setAddListFromFeatureResult(com.microsoft.schemas.sharepoint.soap.AddListFromFeatureResult_type0.Factory.parse(reader));
