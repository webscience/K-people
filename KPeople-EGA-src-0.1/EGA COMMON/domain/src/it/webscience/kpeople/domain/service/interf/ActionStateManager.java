...
public interface ActionStateManager {
    ...
    public String addNewAction(String systemId, String actionType,
            String actionReference);

    public KpeopleEvent addNewEvent(String xMLevent, String numRetries,
            String lastRetry, KpeopleAction fKEventAction);
