...
public class KpeopleLogger {
	private KpeopleLog service;
		   ...
		   private KpeopleLogger() {
			   BundleContext context = FrameworkUtil.getBundle(KpeopleLogger.class).getBundleContext();
			   ServiceReference reference = context.getServiceReference(KpeopleLog.class.getName());
