drop database if exists lportal_kpeople;
create database lportal_kpeople character set utf8;
use lportal_kpeople;
...
insert into Release_ (releaseId, createDate, modifiedDate, servletContextName, buildNumber, verified) values (1, now(), now(), 'portal', 6005, 0);
