...
public class KPeopleServiceExceptionException extends java.lang.Exception{
    ...
    private it.webscience.kpeople.service.event.EventServiceStub.KPeopleServiceExceptionE faultMessage;
    ...
    public void setFaultMessage(it.webscience.kpeople.service.event.EventServiceStub.KPeopleServiceExceptionE msg){
       faultMessage = msg;
    }
    
    public it.webscience.kpeople.service.event.EventServiceStub.KPeopleServiceExceptionE getFaultMessage(){
       return faultMessage;
    }
}
