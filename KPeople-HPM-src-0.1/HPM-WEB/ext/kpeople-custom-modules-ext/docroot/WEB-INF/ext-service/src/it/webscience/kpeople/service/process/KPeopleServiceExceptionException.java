...
public class KPeopleServiceExceptionException extends java.lang.Exception{
    ...
    private it.webscience.kpeople.service.process.ProcessServiceStub.KPeopleServiceExceptionE faultMessage;
    ...
    public void setFaultMessage(it.webscience.kpeople.service.process.ProcessServiceStub.KPeopleServiceExceptionE msg){
       faultMessage = msg;
    }
    
    public it.webscience.kpeople.service.process.ProcessServiceStub.KPeopleServiceExceptionE getFaultMessage(){
       return faultMessage;
    }
}
