...
public class KPeopleServiceExceptionException extends java.lang.Exception{
    ...
    private it.webscience.kpeople.service.cross.GlobalSearchServiceStub.KPeopleServiceExceptionE faultMessage;
    ...
    public void setFaultMessage(it.webscience.kpeople.service.cross.GlobalSearchServiceStub.KPeopleServiceExceptionE msg){
       faultMessage = msg;
    }
    
    public it.webscience.kpeople.service.cross.GlobalSearchServiceStub.KPeopleServiceExceptionE getFaultMessage(){
       return faultMessage;
    }
}
