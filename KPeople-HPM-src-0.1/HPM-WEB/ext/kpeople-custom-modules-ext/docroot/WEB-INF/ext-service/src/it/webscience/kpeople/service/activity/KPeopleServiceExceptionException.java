...
public class KPeopleServiceExceptionException extends java.lang.Exception{
    ...
    private it.webscience.kpeople.service.activity.ActivityServiceStub.KPeopleServiceExceptionE faultMessage;
    ...
    public void setFaultMessage(it.webscience.kpeople.service.activity.ActivityServiceStub.KPeopleServiceExceptionE msg){
       faultMessage = msg;
    }
    
    public it.webscience.kpeople.service.activity.ActivityServiceStub.KPeopleServiceExceptionE getFaultMessage(){
       return faultMessage;
    }
}
