...
public class KPeopleServiceExceptionException extends java.lang.Exception{
    ...
    private it.webscience.kpeople.service.pattern.PatternServiceStub.KPeopleServiceExceptionE faultMessage;
    ...
    public void setFaultMessage(it.webscience.kpeople.service.pattern.PatternServiceStub.KPeopleServiceExceptionE msg){
       faultMessage = msg;
    }
    
    public it.webscience.kpeople.service.pattern.PatternServiceStub.KPeopleServiceExceptionE getFaultMessage(){
       return faultMessage;
    }
}
