var ActivitiesPortlet = {
	open: function() {
		$('.actContainerRpt').animate({
			height: "210px"
		  }, 1000 );
		
		$('.actContainerTop .arrowUp').show();
		$('.actContainerTop .arrowDown').hide();
	},
	...
	close: function() {
		...
		$('.actContainerTop .arrowUp').hide();
		$('.actContainerTop .arrowDown').show();
	}	
}
