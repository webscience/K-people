...
public class ViewAcceptRejectActivity extends Action {
    ...
    private static Log logger = LogFactoryUtil
            .getLog(ViewAcceptRejectActivity.class);
     ...
     *             if the application business logic throws an exception.
     */
    private ActionForward acceptRejectActivity(final ActionMapping mapping,
            final ActionForm form, final HttpServletRequest req,
            final HttpServletResponse res) throws Exception {
        ...
        if (commandValue
                .equalsIgnoreCase(ActivitiesBrowserConstants.ACTIVITY_ACCEPTED)) {
            return acceptActivity(mapping, form, req, res);
        }

        if (commandValue
                .equalsIgnoreCase(ActivitiesBrowserConstants.ACTIVITY_REJECTED)) {
            return rejectActivity(mapping, form, req, res);
        }
        
        if (commandValue
                .equalsIgnoreCase(ActivitiesBrowserConstants.ACTIVITY_REJECTED_CONFIRM)) {
     ...
     *             if the application business logic throws an exception.
     */
    private ActionForward acceptActivity(final ActionMapping mapping,
            final ActionForm form, final HttpServletRequest req,
            final HttpServletResponse res) throws Exception {
        ...
        ActivityServiceStub.ActivityMetadata[] arrayMetadata =
                new ActivityServiceStub.ActivityMetadata[2];

//        primo metadato
        ActivityServiceStub.ActivityMetadata metadata1 =
...
//        secondo metadato
        ActivityServiceStub.ActivityMetadata metadata2 =
                new ActivityServiceStub.ActivityMetadata();
        metadata2
                .setKeyname(ActivitiesBrowserConstants.CONTRIBUTE_ACCEPTED_TYPE);
        ...
        //excuteActivities.setPActivity(psActivity);
        ...
        aReq.setAttribute(ActivitiesBrowserConstants.CURR_ACTIVITY,
                currActivity);
     ...
     *             if the application business logic throws an exception.
     */
    private ActionForward rejectActivity(final ActionMapping mapping,
            final ActionForm form, final HttpServletRequest req,
            final HttpServletResponse res) throws Exception {
     ...
     *             if the application business logic throws an exception.
     */
    private ActionForward confirmRejectActivity(final ActionMapping mapping,
            final ActionForm form, final HttpServletRequest req,
            final HttpServletResponse res) throws Exception {
...
//        psActivity.setHpmActivityId(currActivityHpmId);
        ...
        ActivityServiceStub.ActivityMetadata[] arrayMetadata =
                new ActivityServiceStub.ActivityMetadata[3];
...
//      terzo metadato
        ActivityServiceStub.ActivityMetadata metadata3 =
            new ActivityServiceStub.ActivityMetadata();
        metadata3
            .setKeyname(ActivitiesBrowserConstants.RICHIESTA_CONTRIBUTO_DESCRIZIONE_RIFIUTO);
        ...
        String redirectDettaglio =
            ParamUtil.getString(req,
                    ActivitiesBrowserConstants.REDIRECT_URL);
