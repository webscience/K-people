...
String afterLoginURL= PrefsPropsUtil.getString(company.getCompanyId(),"default.landing.page.path");
String home = themeDisplay.getURLHome();
String current = PortalUtil.getLayoutURL(themeDisplay.getLayout(),themeDisplay);
%>
<c:choose>
	<c:when test="<%= themeDisplay.isSignedIn() %>">
		...
		<div class="signed-as"><liferay-ui:message key="welcome"/></div>
		...
		<div class="my-profile">
			<a href="<%= publicPagesURL%>" > <liferay-ui:message key="my-profile"/></a>
			| <a href="<%= themeDisplay.getURLSignOut() %>">Logout</a>
		</div>
	...
	<c:otherwise>
		...
		<span class="header-login-section">
			<a href="/web/guest"><liferay-ui:message key="login"/></a>
		</span>
	</c:otherwise>
</c:choose>