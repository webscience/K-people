...
/*append user for report*/
String nameUser = themeDisplay.getUser().getFirstName() + "%20" + themeDisplay.getUser().getLastName();;
iframeSrc  += "nameUser=" + nameUser;
baseSrc  += "nameUser=" + nameUser;
/*end*/
