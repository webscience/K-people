...
public class Process extends DataTraceClass {
     ...
     *  <li><b>OWNER</b>: l'utene è il proprietario (owner) del processo</li>
     *  <li><b>ENABLED</b>: il processo è privato e l'utente non ha accesso</li>
     *  <li><b>PRIVATE</b>: il processo è privato e l'utente ha accesso</li>
     * </ul>
     */
    public enum ProcessVisibility { PUBLIC, OWNER, ENABLED, PRIVATE };
    ...
    private Enum<ProcessVisibility> visibility;
     ...
     */
    public final Enum<ProcessVisibility> getVisibility() {
        return visibility;
    }
     ...
     */
    public final void setVisibility(final Enum<ProcessVisibility> in) {
        this.visibility = in;
    }
