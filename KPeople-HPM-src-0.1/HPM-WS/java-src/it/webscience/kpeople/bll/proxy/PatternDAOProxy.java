...
public class PatternDAOProxy implements IPatternDAO {
     ...
     */
    @Override
    public final Pattern patternDetailByHpmPatternId(final Pattern pPattern, final User pUser
            ) throws KPeopleDAOException {
     ...
     */
	@Override
	public Pattern getPatternByHpmPatternId(final String pHpmPatternId) 
		throws KPeopleDAOException
	{
	...
	public PatternType getPatternTypeByPatternTypeId(PatternType pPatternType,
		...
		IPatternDAO patternDao = new PatternDAO();
        return patternDao.getPatternTypeByPatternTypeId(
        		pPatternType , pLoggedUser);
	}
	...
	public PatternState getPatternStateByPatternStateId(
		...
		IPatternDAO patternDao = new PatternDAO();
		return patternDao.getPatternStateByPatternStateId(
	...
	public boolean closePatternFromActiviti(
		...
		throws KPeopleDAOException {
		IPatternDAO patternDao = new PatternDAO();
		return patternDao.closePatternFromActiviti(
