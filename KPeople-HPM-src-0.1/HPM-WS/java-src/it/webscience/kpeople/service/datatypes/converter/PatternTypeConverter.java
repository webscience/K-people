...
public final class PatternTypeConverter {
     ...
     */
    public static it.webscience.kpeople.be.PatternType toBE(
    		final PatternType in) {

        it.webscience.kpeople.be.PatternType out =
            new it.webscience.kpeople.be.PatternType();
     ...
     * @return Lista BE
     */
    public static List<it.webscience.kpeople.be.PatternType>
        toBE(final PatternType[] in) {

        List<it.webscience.kpeople.be.PatternType> out =
            new ArrayList<it.webscience.kpeople.be.PatternType>();
     ...
     */
    public static PatternType[] toService(
            final List<it.webscience.kpeople.be.PatternType> in) {
     ...
     */
    public static PatternType toService(
            final it.webscience.kpeople.be.PatternType in) {
        ...
        if (in != null) {
            ...
            out.setOrdering(in.getOrdering());
            out.setWaitingActivity(in.isWaitingActivity());
            out.setActivitiProcessDefinitionId(
                    in.getActivitiProcessDefinitionId());
            out.setHpmPatternTypeId(in.getHpmPatternTypeId());
        }
