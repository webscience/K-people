...
public interface IEventDAO {
     ...
     */
    List<Event> getEvents(final EventFilter eventFilter,
     ...
     */
    int saveEvent(final Event event, final User user,
	 ...
	 */
	void updateEvent(final Connection pConn, final Event pEvent) 
		throws SQLException;
	 ...
	 * @throws SQLException
	 */
	void saveEventAttachmentAssociation(
	 ...
	 * @throws SQLException
	 */
	boolean existsEventAttachmentAssociation(
			final int pIdAttachment, 
			final int pIdEvent) 
		throws SQLException;
