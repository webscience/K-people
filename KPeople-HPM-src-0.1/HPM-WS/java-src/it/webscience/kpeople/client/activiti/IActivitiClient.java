...
/*
 * Interfaccia che definisce i metodi per il client Activiti.
 */
public interface IActivitiClient {
	 ...
	 * @throws KPeopleActivitiStartPatternException
	 */
	ActivitiProcessInstance startActivitiProcessObj(
			final String jSonParams) 
		throws KPeopleActivitiStartPatternException;
	 ...
	 * @throws KPeopleActivitiPerformTaskOperationException
	 */
	ActivitiTaskPerformResponse performTaskOperationObj(
			final String pTaskId, 
			final String pJSonParams,
			final String pTaskOperation)
		throws KPeopleActivitiPerformTaskOperationException;
	 ...
	 * @throws KPeopleActivitiListTaskException
	 */
	ActivitiUserTaskList listTasksAssigneeObj(
			final String pUserId) 
		throws KPeopleActivitiListTaskException;
	 ...
	 * @throws KPeopleActivitiListTaskException
	 */
	ActivitiUserTaskList listTasksCandidateObj(
			final String pUserId) 
		throws KPeopleActivitiListTaskException;
	 ...
	 * @throws KPeopleActivitiListTaskException
	 */
	String listTasksCandidateGroup(
	 ...
	 * @throws KPeopleActivitiListTaskException
	 */
	ActivitiUserTaskList listTasksCandidateGroupObj(
			final String pGroupId) 
		throws KPeopleActivitiListTaskException;
