 ...
 * @author dellanna
 */
public class TestOcSolrAnnotator {
    /** xml inviato all'AE. */
    ...
    public static void main(final String[] args) throws Exception {
        TestOcSolrAnnotator test = new TestOcSolrAnnotator(args);

        for (int i = 1; i <= 1; i++) {
            String analysisEngine =
                    "C:\\kpeople-sviluppo\\k-peopleWorkSpace\\uimaJava\\descriptors\\webscience\\analysisEngines\\ocAnalysisEngineDescriptor.xml";
            ...
            File xmlTest =
                    new File(
                            "C:\\kpeople-sviluppo\\k-peopleWorkSpace\\uimaJava\\src\\test\\event\\event-249"
                                    + i + ".xml");
     ...
     *             ex
     */
    private void processFile(final File aFile, final AnalysisEngine aAE,
            final CAS aCAS) throws Exception {
     ...
     */
    public TestOcSolrAnnotator(final String[] args) {
        super();
