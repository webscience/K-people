...
//    creo l'annotation di test
    RoomNumber roomNumber = new RoomNumber(aJCas);
    roomNumber.setBegin(0);
    roomNumber.setEnd(20);
    roomNumber.setTest(234.);
    roomNumber.addToIndexes();
    roomNumber.setBuilding("Palazzo 4 piani");
    ...
    for (int i = 0; i < mPatterns.length; i++) {
      ...
      while (matcher.find()) {
        ...
        annotation.setBuilding("eee" + mLocations[i]);
