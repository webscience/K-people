 ...
 * @generated */
public class UserReceiverToAnnotation extends UserAnnotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(UserReceiverToAnnotation.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected UserReceiverToAnnotation() {}
    
  /** Internal - constructor used by generator 
   * @generated */
  public UserReceiverToAnnotation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public UserReceiverToAnnotation(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public UserReceiverToAnnotation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
