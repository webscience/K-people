...
public class AttachmentAnnotation extends Annotation {
   ...
   * @generated */
  public String getId() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  //*--------------*
  //* Feature: attachmentType

  /** getter for attachmentType - gets 
   * @generated */
  public String getAttachmentType() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_attachmentType == null)
      jcasType.jcas.throwFeatMissing("attachmentType", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  //*--------------*
  //* Feature: attachmentData

  /** getter for attachmentData - gets 
   * @generated */
  public String getAttachmentData() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_attachmentData == null)
      jcasType.jcas.throwFeatMissing("attachmentData", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  //*--------------*
  //* Feature: attachmentName

  /** getter for attachmentName - gets 
   * @generated */
  public String getAttachmentName() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_attachmentName == null)
      jcasType.jcas.throwFeatMissing("attachmentName", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  public String getHashcode() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_hashcode == null)
      jcasType.jcas.throwFeatMissing("hashcode", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  public String getUrlAttachment() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_urlAttachment == null)
      jcasType.jcas.throwFeatMissing("urlAttachment", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  public String getAuthor() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_author == null)
      jcasType.jcas.throwFeatMissing("author", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
  ...
  public String getCreationDate() {
    if (AttachmentAnnotation_Type.featOkTst && ((AttachmentAnnotation_Type)jcasType).casFeat_creationDate == null)
      jcasType.jcas.throwFeatMissing("creationDate", "it.webscience.uima.annotations.eventData.AttachmentAnnotation");
