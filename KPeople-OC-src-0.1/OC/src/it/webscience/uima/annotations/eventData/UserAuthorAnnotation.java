 ...
 * @generated */
public class UserAuthorAnnotation extends UserAnnotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(UserAuthorAnnotation.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected UserAuthorAnnotation() {}
    
  /** Internal - constructor used by generator 
   * @generated */
  public UserAuthorAnnotation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public UserAuthorAnnotation(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public UserAuthorAnnotation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
