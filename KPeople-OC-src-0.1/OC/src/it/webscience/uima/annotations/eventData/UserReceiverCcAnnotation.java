 ...
 * @generated */
public class UserReceiverCcAnnotation extends UserAnnotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(UserReceiverCcAnnotation.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected UserReceiverCcAnnotation() {}
    
  /** Internal - constructor used by generator 
   * @generated */
  public UserReceiverCcAnnotation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public UserReceiverCcAnnotation(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public UserReceiverCcAnnotation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
