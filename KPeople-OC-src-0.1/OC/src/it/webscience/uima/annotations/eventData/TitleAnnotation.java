...
public class TitleAnnotation extends Annotation {
  ...
  public String getValue() {
    if (TitleAnnotation_Type.featOkTst && ((TitleAnnotation_Type)jcasType).casFeat_value == null)
      jcasType.jcas.throwFeatMissing("value", "it.webscience.uima.annotations.eventData.TitleAnnotation");
