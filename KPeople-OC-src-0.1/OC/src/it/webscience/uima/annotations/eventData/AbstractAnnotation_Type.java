...
public class AbstractAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("it.webscience.uima.annotations.eventData.AbstractAnnotation");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "it.webscience.uima.annotations.eventData.AbstractAnnotation");
