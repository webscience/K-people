...
public class AbstractAnnotation extends Annotation {
  ...
  public String getValue() {
    if (AbstractAnnotation_Type.featOkTst && ((AbstractAnnotation_Type)jcasType).casFeat_value == null)
      jcasType.jcas.throwFeatMissing("value", "it.webscience.uima.annotations.eventData.AbstractAnnotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((AbstractAnnotation_Type)jcasType).casFeatCode_value);}
  ...
  public void setValue(String v) {
    if (AbstractAnnotation_Type.featOkTst && ((AbstractAnnotation_Type)jcasType).casFeat_value == null)
      jcasType.jcas.throwFeatMissing("value", "it.webscience.uima.annotations.eventData.AbstractAnnotation");
    jcasType.ll_cas.ll_setStringValue(addr, ((AbstractAnnotation_Type)jcasType).casFeatCode_value, v);}    
  }
