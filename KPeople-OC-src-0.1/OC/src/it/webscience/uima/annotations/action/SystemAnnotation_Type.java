...
public class SystemAnnotation_Type extends Annotation_Type {
  ...
  /** @generated */
  public final static int typeIndexID = SystemAnnotation.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("it.webscience.uima.annotations.action.SystemAnnotation");
  ...
  public String getSystemId(int addr) {
        if (featOkTst && casFeat_systemId == null)
      jcas.throwFeatMissing("systemId", "it.webscience.uima.annotations.action.SystemAnnotation");
  ...
  public String getSystemType(int addr) {
        if (featOkTst && casFeat_systemType == null)
      jcas.throwFeatMissing("systemType", "it.webscience.uima.annotations.action.SystemAnnotation");
