...
public class AsClient_ {
	 ...
	 */
	public AsClient_(String args[]) throws Exception {
		collectionReaderDescriptor = new File("C:\\WebScience\\Progetti\\K-People\\OntologyController_UIMA\\apache-uima\\examples\\descriptors\\collection_reader\\FileSystemCollectionReader.xml");
		
		outputDir = new File("C:\\WebScience\\Progetti\\K-People\\OntologyController_UIMA\\apache-uima\\examples\\data\\processed");
...
//		uimaAsEngine.addStatusCallbackListener(new StatusCallbackListener());
		...
		String filePath = "C:\\WebScience\\Progetti\\K-People\\OntologyController_UIMA\\apache-uima\\examples\\src\\it\\webscience\\uima\\event-2031.xml";
...
//		Send Cas to service for processing
	...
	public static void main(String[] args) throws Exception {
		AsClient_ runner = new AsClient_(args);
		runner.run();
	}
