...
CREATE TABLE `event_metadata` (
  `ID_EVENT_METADATA` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_EVENT_METADATA`),
  KEY `R_28` (`ID_EVENT`)
) ENGINE=MyISAM AUTO_INCREMENT=10142 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2011-06-08 18:13:42
