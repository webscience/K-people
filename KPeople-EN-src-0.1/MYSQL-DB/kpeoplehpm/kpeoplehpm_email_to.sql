...
CREATE TABLE `email_to` (
  ...
  KEY `R_44` (`ID_ATTACHMENT`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `email_to`
--

LOCK TABLES `email_to` WRITE;
/*!40000 ALTER TABLE `email_to` DISABLE KEYS */;

/*!40000 ALTER TABLE `email_to` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2011-06-08 18:13:52
