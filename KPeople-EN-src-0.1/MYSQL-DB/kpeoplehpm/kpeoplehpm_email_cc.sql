...
CREATE TABLE `email_cc` (
  ...
  KEY `R_46` (`ID_ATTACHMENT`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `email_cc`
--

LOCK TABLES `email_cc` WRITE;
/*!40000 ALTER TABLE `email_cc` DISABLE KEYS */;

/*!40000 ALTER TABLE `email_cc` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2011-06-08 18:04:51
