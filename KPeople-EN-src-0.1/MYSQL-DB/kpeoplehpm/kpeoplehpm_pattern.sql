...
CREATE TABLE `pattern` (
  ...
  `ACTIVITI_PROCESS_INSTANCE_ID` varchar(255) DEFAULT NULL,
  `DATE_DUE` date DEFAULT NULL,
  `ID_PATTERN_STATE` int(11) DEFAULT NULL,
  `HPM_PATTERN_ID` varchar(255) NOT NULL,
  `WAITING_ACTIVITY` bit(1) DEFAULT NULL,
  `WAITING_ACTIVITY_DATE` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ID_ATTACHMENT`),
  KEY `R_30` (`ID_PATTERN_TYPE`),
  KEY `R_56` (`ID_PATTERN_STATE`)
...
-- Dump completed on 2011-06-08 18:03:50
