...
--
-- Table structure for table `process_metadata`
--
...
CREATE TABLE `process_metadata` (
  `ID_PROCESS_METADATA` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_PROCESS_METADATA`),
  KEY `R_23` (`ID_PROCESS`)
) ENGINE=MyISAM AUTO_INCREMENT=1000 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `process_metadata`
--

LOCK TABLES `process_metadata` WRITE;
/*!40000 ALTER TABLE `process_metadata` DISABLE KEYS */;
/*!40000 ALTER TABLE `process_metadata` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2011-06-08 18:13:31
