...
--
-- Table structure for table `pattern_metadata`
--
...
CREATE TABLE `pattern_metadata` (
  `ID_PATTERN_METADATA` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `ACTIVITI_PROCESS_METADATA` bit(1) DEFAULT NULL,
  PRIMARY KEY (`ID_PATTERN_METADATA`),
  KEY `R_27` (`ID_PATTERN`)
) ENGINE=MyISAM AUTO_INCREMENT=460 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pattern_metadata`
--

LOCK TABLES `pattern_metadata` WRITE;
/*!40000 ALTER TABLE `pattern_metadata` DISABLE KEYS */;
/*!40000 ALTER TABLE `pattern_metadata` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2011-06-08 18:02:10
