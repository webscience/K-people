...
CREATE TABLE `activity` (
  ...
  `ACTIVITI_PROCESS_TASK_ID` varchar(255) DEFAULT NULL,
  `ACTIVITY_OWNER` int(11) NOT NULL,
  `ACTIVITY_REQUESTOR` int(11) NOT NULL,
  `DELETED_BY` int(11) DEFAULT NULL,
  `ID_PATTERN` int(11) DEFAULT NULL,
  `TITLE` varchar(255) DEFAULT NULL,
  `HPM_ACTIVITY_ID` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2011-06-08 18:14:28
