...
CREATE TABLE `attachment` (
  ...
  `ID_ATTACHMENT_TYPE` int(11) NOT NULL,
  `HPM_ATTACHMENT_ID` varchar(255) DEFAULT NULL,
  `NAME` varchar(255) DEFAULT NULL,
  `ID_USER` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_ATTACHMENT`),
  KEY `R_16` (`ID_ATTACHMENT_TYPE`)
) ENGINE=MyISAM AUTO_INCREMENT=1505 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2011-06-08 18:49:58
